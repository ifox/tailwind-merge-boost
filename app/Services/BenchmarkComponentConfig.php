...
class BenchmarkComponentConfig
{
    ...
    public static function getConfigs(): array
    {
        return [
            ...
            'modal' => [
                ['class' => 'bg-black/50'],
                ['class' => 'bg-gray-900/75 backdrop-blur-sm'],
                ['class' => 'fixed inset-0 bg-black/60 flex items-center justify-center'],
                ['class' => 'bg-gray-900/80 backdrop-blur-md flex items-center justify-center p-4'],
                ['class' => 'fixed inset-0 bg-gradient-to-br from-black/70 to-gray-900/70 flex items-center justify-center'],
                ['class' => 'bg-black/50 backdrop-blur-lg flex items-center justify-center transition-opacity duration-300'],
                ['class' => 'fixed inset-0 bg-gray-900/90 flex items-center justify-center p-4 z-50 overflow-y-auto'],
                ['class' => 'bg-gradient-to-t from-black/80 to-transparent flex items-end sm:items-center justify-center min-h-screen'],
                ['class' => 'fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 transition-all duration-300 ease-out'],
                ['class' => 'md:p-6 lg:p-8 fixed inset-0 bg-gray-900/80 backdrop-blur-md flex items-center justify-center z-50 overflow-y-auto transition-all duration-300'],
            ],
            'tabs' => [
                ['class' => 'flex gap-2'],
